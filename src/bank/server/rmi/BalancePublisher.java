...
//        registerProperty();
    ...
    private void createRegistry() {
        // Create registry.
        try {
            System.out.println("SERVER: Trying to create registry on port " + ConnConst.PUBLISHER_PORT + "...");
            registry = LocateRegistry.createRegistry(ConnConst.PUBLISHER_PORT);
            System.out.println("SERVER: Registry created on port " + ConnConst.PUBLISHER_PORT);
    ...
    private void bindPublisher() {
        ...
        try {
            ...
            registry.rebind(ConnConst.PUBLISHER_BINDING_NAME, this);
            System.out.println("SERVER: RemotePublisher registered as " + ConnConst.PUBLISHER_BINDING_NAME + " on port " + ConnConst.PUBLISHER_PORT);
        } catch (RemoteException ex) {
    ...
    public void informBalance(IBankAccount bankAccount) {
        ...
        System.out.println("SERVER: Trying to send balance to '" + propertyName + "'... ");
        try {
            super.inform(propertyName, null, bankAccount.getBalance());
            System.out.println("SERVER: Balance to '" + propertyName + "' successfully sent!");
        } catch (Exception ex) {
